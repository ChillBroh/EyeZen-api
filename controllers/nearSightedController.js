let displayedNumber = ""; // Store the currently displayed number
let correctCount = 0; // Store the count of correct guesses
let chancesLeft = 3; // Store the number of chances left
